            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-md-6">
                        ...
                        <p><strong>Do you have a registry?</strong> <br/> We have a cozy home and don't require any additional items, but if you'd like, contributions to our honeymoon fund would be greatly appreciated <a class="btn-light" href="https://www.paypal.com/paypalme/theguardswedding" target="_blank" >here</a>.</p>
                    </div>
                    <div
