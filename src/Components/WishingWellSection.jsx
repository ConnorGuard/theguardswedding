    ...
    return (
        <section id="faqs" className="sand-dark-bg py-5">
            ...
            <div className="row align-items-center">
                ...
                <h2>Wishing Well</h2>
                <p>Many of you are traveling across the globe to celebrate with us in Brisbane, so your presence means the world to us and is all we ask for. If you'd still like to contribute to our honeymoon funds, please click <a class="btn-light" href="https://www.paypal.com/paypalme/theguardswedding" target="_blank" >here</a> or scan the QR code.</p>
